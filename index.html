...
<link type="text/css" rel="stylesheet" href="broadcast.css" >
<link type="text/css" rel="stylesheet" href="prj_childfood.css" >
<body>
        <div class="header">
        ...
        <div class="nav">
                <ul>
                    <li><a href="#">房子</a></li>
                    <li><a href="#">博客园</a></li>
                    <li><a href="#">VIP会员专区</a></li>
                    <li><a href="#">儿童食品在线选购</a></li>
                    <li><a href="#">美食社区</a></li>
                    <li><a href="#">食品知识</a></li>
                    <li><a href="#">网站帮助</a></li>
        ...
        <div class="footer">
           ...
           <li>查看最新<a href="#" ></a></li> 
           <li>写博客 <a href="#" ></a></li>
            <li>进入博客园<a href="#" ></a></li>
          </br>
            <ul>VIP专区</ul>
          </br>
            <li>VIP会员登录<a href="#" ></a></li>
            <li>申请VIP会员<a href="#" 申请VIP会员></a></li>
            <li>订阅免费期刊<a href="#" 订阅免费期刊></a></li>
           <li>VIP会员的优惠<a href="#" VIP会员的优惠></a></li> 
           <li>VIP会员帮助<a href="#" VIP会员帮助></a></li> 
           </div>
           <div class="foot_3">
            <ul>儿童食品选购</ul>
          </br>
            <li>婴幼儿食品<a href="#"></a></li>
            <li>1~3岁儿童食品<a href="#"></a></li>
            <li>儿童乳制品<a href="#"></a></li>
            <li>儿童零食<a href="#"></a></li>
            <li>儿童饮料<a href="#"></a></li>
            <li>专家咨询<a href="#"></a></li>
           </div>
           <div class="foot_4">
            ...
            <li>食物的搭配<a href="#"></a></li>
            <li>食物营养学<a href="#"></a></li>
            <li>注意要点<a href="#"></a></li>
            <li>在线咨询<a href="#"></a></li>
           </div>
           <div class="foot_5">
